...
FIND_PATH(NEMESIS_INCLUDE_DIR DBC.hh
     HINTS ${SCALE_ROOT_DIR}/Exnihilo
     "${SCALE_ROOT_DIR}/${CMAKE_SYSTEM_NAME}_${CMAKE_SYSTEM_PROCESSOR}"
     PATHS /opt/scale6.2b5
     PATH_SUFFIXES packages/Nemesis/harness)
...
IF(SCALE_INCLUDE_DIR AND ORIGEN_CORE_LIBRARY AND ORIGEN_SOLVER_LIBRARY)
   # AND NEMESIS_GTEST_LIBRARY)
    SET(SCALE_FOUND 1)
