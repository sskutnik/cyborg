...
get_filename_component(ORIGEN_INCLUDE_DIR "${ORIGEN_INCLUDE_DIR}/../.." ABSOLUTE)
#get_filename_component(ORIGEN_INCLUDE_DIR ${ORIGEN_INCLUDE_DIR} PATH)
...
# Find the SCALE-provided Qt libraries, if available
FIND_LIBRARY(SCALE_QT_CORE NAMES QtCore
    HINTS ${SCALE_ROOT_DIR}/${CMAKE_SYSTEM_NAME}_${CMAKE_SYSTEM_PROCESSOR}
    ${SCALE_ROOT_DIR}
    PATH_SUFFIXES lib)
# Need the Qt includes as well
# Note: this WILL fail for now, as SCALE doesn't appear to include the Qt
# headers; however, putting this in place for the future
FIND_PATH(QT_INCLUDE_DIR QString.h
    HINTS ${SCALE_ROOT_DIR}/${CMAKE_SYSTEM_NAME}_${CMAKE_SYSTEM_PROCESSOR}
          ${SCALE_ROOT_DIR}
    PATH_SUFFIXES include )
get_filename_component(ORIGEN_INCLUDE_DIR "${QT_INCLUDE_DIR}" ABSOLUTE)

# Default to system Qt if we can't find QtCore headers AND library with SCALE
IF(NOT (SCALE_QT_CORE AND QT_INCLUDE_DIR) )
   UNSET(SCALE_QT_CORE CACHE)
...
#    SET(SCALE_LIBRARIES ${ORIGEN_CORE_LIBRARY} ${ORIGEN_SOLVER_LIBRARY})
    ...
    IF(SCALE_QT_CORE)
       SET(SCALE_LIBRARIES ${SCALE_LIBRARIES} ${SCALE_QT_CORE})
    ENDIF()
ELSE()
    SET(SCALE_FOUND 0)
    UNSET(SCALE_LIBRARIES CACHE)
    UNSET(SCALE_INCLUDE_DIRS CACHE)
ENDIF()
...
ELSE(SCALE_FOUND)
    SET(SCALE_DIR_MESSAGE
        "SCALE was not found. Make sure SCALE_LIBRARIES and SCALE_INCLUDE_DIRS are set.")
